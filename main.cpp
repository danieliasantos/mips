...
class T {
private:
    string(*expression)(Instructions &s, vector<int>& v);
public:
    T(string(*exp)(Instructions &s, vector<int>& v)) : expression(exp) {}
    string execute(Instructions &s, vector<int>& v) {
